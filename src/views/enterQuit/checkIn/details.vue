<template>
  <el-form
    ...
    <!-- 入住配置 -->
    <ConfigurationForm :type="type" :configInfo="configInfo" ref="configForm"
                       @getFormData="getFormData"></ConfigurationForm>

    <!-- 签约办理 -->
    <TransactForm ref="transactForm" @getFormData="getFormData" :type="type"
                  :transactFormInfo="transactFormInfo"></TransactForm>

    <!-- 提交按钮 -->
    <div class="info center">
      <el-button type="primary" v-if="type!=='read'" @click="submitForm">提交</el-button>
